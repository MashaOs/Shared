...
public class TasksSQLiteDB {
	 ...
	 * Tag to print in Log.
	 */
	static final String CLASS_TAG = "SQLiteDBTaskAdapter";
	...
	public long addTask(Task t) {
		...
		Log.i(CLASS_TAG, "New task added: " + t.getTitle());
	...
	public boolean deleteAll() {
		waitWhileLocked();
		Log.i(CLASS_TAG, "The table " + AppConstants.TABLE_NAME + " was deleted.");
	...
	public void deleteTask(Task task) {
	    ...
	    Log.i(CLASS_TAG, "Task deleted: " + task.getTitle());
	}
